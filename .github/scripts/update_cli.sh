...
mv ./tmp/cx.exe ./checkmarx-ast-teamcitytest-plugin-agent/src/runner/bin/2.0.0/cx.exe
rm -r tmp
rm ${filename_windows}
...
mv ./tmp/cx ./checkmarx-ast-teamcitytest-plugin-agent/src/runner/bin/2.0.0/cx
rm -r tmp
rm ${filename_linux}
...
mv ./tmp/cx ./checkmarx-ast-teamcitytest-plugin-agent/src/runner/bin/2.0.0/cx-mac
rm -r tmp
rm ${filename_darwin}